...
export default async function SettingsPage({ searchParams }: { searchParams: Promise<{ bind?: string }> }) {
 ...
 ? new Intl.DateTimeFormat("zh-CN", { year: "numeric", month: "long", day: "numeric" }).format(profile.createdAt)
 : null;
 ...
 {githubAccount ? "已绑定，可直接使用 GitHub 登录本账号" : githubEnabled ? "未绑定" : "站点未开启 GitHub 登录"}
 </p>
 </div>
 {githubEnabled &&
 (githubAccount ? (
