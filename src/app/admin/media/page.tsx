  ...
  return (
    <div>
      ...
      <form className="mb-4 flex flex-wrap items-center gap-2" method="get">
        ...
        <button
          type="submit"
          className="rounded-none border border-brand-200 bg-surface px-3 py-1.5 text-xs text-neutral-700 hover:border-brand-500"
        >
          筛选
        </button>
      </form>
