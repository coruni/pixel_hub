...
export default function NavCategoriesMenu({ label, items }: { label: string; items: NavCategory[] }) {
 ...
 {label}
 <ChevronDown size={13} className={`text-neutral-400 transition ${open ? "rotate-180" : ""}`} aria-hidden />
 </button>
