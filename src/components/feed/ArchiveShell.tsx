...
import { renderSiteSidebar, WidgetArea } from "@/components/sidebar/SiteSidebar";
 ...
 */
export default async function ArchiveShell({
  heading,
  children,
}: {
  heading?: ReactNode;
  ...
  // 先解析真实侧栏内容再交给布局，游客不会为登录专属模块留下空列。
  const rail = await renderSiteSidebar({ theme, page: "archive", authed: !!u });
